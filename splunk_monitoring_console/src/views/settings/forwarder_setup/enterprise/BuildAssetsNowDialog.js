define([
    ...
    var DO_IT_LATER_BUTTON = '<a href="#" class="btn modal-btn-cancel cancel pull-left" data-dismiss="modal">'+_('Later').t()+'</a>';
    ...
    return Modal.extend({
        ...
        render: function() {
            ...
            this.$(Modal.FOOTER_SELECTOR).append(DO_IT_LATER_BUTTON);
